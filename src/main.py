...
from pdf_processor import convert_pdf_to_images, extract_layout_data_from_pdf
    ...
    try:
        ...
        if task:
            ...
            try:
                ...
                # Process with LayoutLMv3 (raw predictions)
                logger.info(f"Processing with LayoutLMv3 (PyMuPDF + raw predictions)...")
